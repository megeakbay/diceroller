...
def check_camera_matches_2d() -> None:
    ...
    # The octahedron sits a little lower than the cube. Matching them was
    # tried and flattened the lattice without buying anything.
    check("octahedron renders from 26 deg",
